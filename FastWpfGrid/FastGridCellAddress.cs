...
public readonly struct FastGridCellAddress {
	public static readonly FastGridCellAddress Empty = new();
	public static readonly FastGridCellAddress GridHeader = new(row: null, col: null, isGridHeader: true);
	...
	public override bool Equals(object obj) {
		return obj != null && obj is FastGridCellAddress address && Equals(address);
	}
	...
	public readonly bool IsGridHeader;
