...
internal readonly unsafe struct BitmapContext : IDisposable
{
	...
	private static readonly IDictionary<WriteableBitmap, int> UpdateCountByBmp = new Collections.Concurrent.ConcurrentDictionary<WriteableBitmap, int>();
	...
	{
		[Runtime.TargetedPatchingOptOut("Candidate for inlining across NGen boundaries for performance reasons")]
		get => _backBuffer;
	}
