...
internal class ClearTypeLetterGlyph
{
	public struct Item
	{
		public short X;
	...
	public static ClearTypeLetterGlyph CreateGlyph(GlyphTypeface glyphTypeface, Font font, double size, char ch, Color fontColor, Color bgColor)
	{
		if (ch == ' ')
		{
		...
		using (Bitmap bmp1 = new(1, 1, System.Drawing.Imaging.PixelFormat.Format32bppPArgb))
		{
			using Graphics g = Graphics.FromImage(bmp1);
			//var sizef = g.MeasureString("" + ch, font, new PointF(0, 0), StringFormat.GenericTypographic);
			SizeF sizef = g.MeasureString("" + ch, font, new PointF(0, 0), StringFormat.GenericTypographic);
		...
		using (Bitmap bmp = new(width, height, System.Drawing.Imaging.PixelFormat.Format32bppPArgb))
		{
			System.Drawing.Color fg2 = System.Drawing.Color.FromArgb(fontColor.A, fontColor.R, fontColor.G, fontColor.B);
			System.Drawing.Color bg2 = System.Drawing.Color.FromArgb(bgColor.A, bgColor.R, bgColor.G, bgColor.B);

			using (Graphics g = Graphics.FromImage(bmp))
			{
				g.FillRectangle(new SolidBrush(bg2), new Rectangle(0, 0, width, height));
				g.DrawString("" + ch, font, new SolidBrush(fg2), 0, 0, StringFormat.GenericTypographic);
			}
